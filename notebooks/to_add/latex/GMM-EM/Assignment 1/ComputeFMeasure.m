function [Results]=ComputeFMeasure(DBpath,SegResultsSubPath,SysType)
...
for i=1:length(Lpath)
    ...
    [Pmax Rmax Fmax]=CalcCandScore(cell2mat(strcat(DBpath,Sep,Lpath(i),Sep,SegResultsSubPath,Sep)),Hmask, length(SegResultsSubPath));
    Results(i,1)=Fmax;
    Results(i,2)=Rmax;
    Results(i,3)=Pmax;
end;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [Pmax Rmax Fmax]=CalcCandScore(SegPath,HumanSeg,n)
...
for i=1:length(k);
   ...
   imgPath = [SegPath k(i).name];
   Segmap=imread(imgPath);
