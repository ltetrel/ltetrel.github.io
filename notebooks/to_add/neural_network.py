...
# %% [markdown]
'''
McCulloch et al. (McCulloch, Warren S., and Walter Pitts. "A logical calculus of the ideas immanent in nervous activity." The bulletin of mathematical biophysics 5.4 (1943): 115-133.)
...
Rosenblatt (Rosenblatt, Frank. The perceptron, a perceiving and recognizing automaton Project Para. Cornell Aeronautical Laboratory, 1957.) used a 
...
Nowadays, we used the widely adopted softmax (sigmoid for binary) popularized for neural nets by Bridle (Bridle, John S. "Probabilistic interpretation of feedforward classification
