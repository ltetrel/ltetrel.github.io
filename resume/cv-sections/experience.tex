...
\cventry
{Software Developer (*): Academic research}% Job title
...
{ % Description(s) of tasks/responsibilities
	\begin{cvitems}
		...
		\subitem {Open-source development in Python (tensorflow/keras, Docker) and community support (github)}
		\subitem {Deep learning for fMRI preprocessing (3D registration) and feature visualization from brain-state annotation}
		\subitem {CPU-HPC distributed (intelMPI) and GPU training}
		\item {CONP-Neurolibre : open and interactive neuroscience notebooks on the cloud}
		\subitem {Server admin (binderhub, k8s, Docker)}
		\subitem {Reviewer for the neurolibre submissions}
...
\cventry
{Computer vision scientist (*): 3D solutions for digital dentistry.}% Job title
